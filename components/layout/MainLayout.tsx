...
import MiniMapScroll from '../MiniMapScroll';
import CompareTray from '../CompareTray';
import LoadingSkeleton from '../LoadingSkeleton';
import AccessibilityAnnouncer from '../AccessibilityAnnouncer';
import ToastContainer from '../Toast';
import { MessageSquareIcon, SearchIcon, MinimizeIcon } from '../icons';
...
const FlipView = React.lazy(() => import('../FlipView'));
const CarouselView = React.lazy(() => import('../CarouselView'));
const ThreeDView = React.lazy(() => import('../ThreeDView'));
const StoryView = React.lazy(() => import('../StoryView'));
const ForYouView = React.lazy(() => import('../ForYouView'));
