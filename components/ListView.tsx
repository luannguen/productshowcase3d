        ...
        >
          ...
          <div className="mt-4 sm:mt-0 sm:ml-6 text-center sm:text-right flex-shrink-0 z-10">
            ...
            <motion.button 
              ...
              className="mt-3 w-full px-4 py-2 bg-[var(--primary-accent)] text-white font-semibold rounded-[var(--border-radius)] hover:bg-[var(--primary-accent-hover)] transition-colors duration-200 flex items-center justify-center gap-2"
